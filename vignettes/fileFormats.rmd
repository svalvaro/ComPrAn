...
## Peptide input file
*data.txt* file in an example data set  
Input file needs to be a text file with tab deliminated values. Data are organized in a column format, first row contain column headers. 
This file must contain following columns, format of values inside each column is also specified:   
