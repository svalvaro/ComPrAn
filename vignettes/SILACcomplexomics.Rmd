...
peptides <- simplifyProteins(peptides) # remove unnecessary columns, simplify rows
...
if (human) {
normTableForExport(protNormLab, protNormUnlab, protNormComb) # file in nicely human readable format
} else {
  normTableWideToLong(protNormLab, protNormUnlab, protNormComb) # file in format required for further analysis
}
